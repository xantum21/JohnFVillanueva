...
7. Open https://johnfvillanueva.com/release-version.txt and confirm it says
   `2026-09-10-v8.2`; this distinguishes the current release from older downloads.

The custom domain is `johnfvillanueva.com`; keep `CNAME` and `.nojekyll` at the
repository root. See `RELEASE-NOTES-2026-09-10-v8.2.md` for this pass's verification summary.
